...
const argv = yargs(process.argv.slice(2))
  ...
  .option("addSpacesBetweenChineseCharAndAlphabeticalChar", {
    type: "boolean",
    description:
      "Add spaces between Chinese characters and alphabetical characters",
  })
...
const config = {
  mainFeature: {
    ...
    fullWidthCharsAndFollowingSpaces:
      argv.fullWidthCharsAndFollowingSpaces || true,
    addSpacesBetweenChineseCharAndAlphabeticalChar:
      argv.addSpacesBetweenChineseCharAndAlphabeticalChar || true,
    halfWidthCharsAndFollowingSpaces:
      argv.halfWidthCharsAndFollowingSpaces || true,
  },
  useSimpleQuotation: argv.useSimpleQuotation || true,
  ellipsisCount: (argv.ellipsisCount as 6 | 3) || 3,
};
